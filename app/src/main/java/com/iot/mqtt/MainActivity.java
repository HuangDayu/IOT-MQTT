...
public class MainActivity extends Activity {//AppCompatActivity
    ...
    private void initUI() {
        ...
        button_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isCanPushData()) {
                    mqttManger.publishMqttPayloadJson(str4_en, str3_en);
    ...
    public void initSetting() {
        ...
        setEquipment_Topic(userSettings.getString("Equipment_Topic", "yibuwulianwang"));
    ...
    public void setEvenEnum(EvenEnum connectionState) {
        switch (connectionState) {
            ...
            case MQTT_PUBLISH_TRUE:
                printlnUpTextView(MqttManager.getData()+" 发布消息：");
                break;
            case MQTT_PUBLISH_FALSE:
                printlnUpTextView(MqttManager.getData()+" 发布失败！");
                setIsRedTextView(true);
                break;
            case MQTT_CLIENT_RECEIVE_TRUE:
                printlnUpTextView(MqttManager.getData()+" 收到消息：");
                break;
            case MQTT_EXCEPTION:
            ...
            case MQTT_SERVER_RECEIVE_TRUE:
                printlnUpTextView(MqttManager.getData()+" 发布成功。");
                break;
